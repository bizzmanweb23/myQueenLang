...
@section('javascript')
    ...
    <script>
        function showmlmusers(params) {
            $.ajax({
                type: "GET",
                url: "{{ route('affilatemarketing.create') }}",
                dataType: "json",
		...
		function viewUsers(id) {			
            ...
            $.ajax({
                url: "{{ route('view_affilate_details') }}",
                type: "get",
                data: {
                    "_token": "{{ csrf_token() }}",
                    id: id
                ...
                success: function(data) {
                  ...
                  $('#emailAddress').val(data.email_id);
		...
		function editUsers(id) {			
            ...
            $.ajax({
                url: "{{ route('get_affilate_details') }}",
                type: "get",
                data: {
                    "_token": "{{ csrf_token() }}",
                    id: id
		...
		$('#edit_user_btn').click(function() {
            ...
            $.ajax({
                url: "{{ route('edit_affilate_details') }}",
                type: "POST",
                data: data,
                dataType: 'json',
                processData: false,
		...
		function showmatchingbonus(params) {
            $.ajax({
                type: "GET",
                url: "{{ route('getmatchingbonusdetails.create') }}",
                dataType: "json",
                success: function(data) {
                     //console.log(data)
                    params.success(data)
		...
		function showdirectsponsors(params) {
            $.ajax({
                type: "GET",
                url: "{{ route('getdirectsponserdetails.create') }}",
                dataType: "json",
                success: function(data) {
                     //console.log(data)
                    params.success(data)
		...
		function showleadershipsponsors(params) {
            $.ajax({
                type: "GET",
                url: "{{ route('getleadershipbonusdetails.create') }}",
                dataType: "json",
                success: function(data) {
                     //console.log(data)
                    params.success(data)
